...
def main(path_start:str, 
    ...
    subprocess.run("python3 muffin/run/run_ensemble-preprocess-stats.py --path_results " + path_sim + " --num_nodes " + str(num_nodes) + " --initialisation " + initialisation + " --r_max " + str(r_max), shell=True)
