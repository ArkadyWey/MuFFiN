...
class Parameters():
    ...
    # -----
        ...
        self.mu:float           = self.dictionary["mu"]
        self.sigma:float        = self.dictionary["sigma"]
    ...
    def get_parameters_parser(self):
        ...
        parser.add_argument("-mu",   "--mu",             type=float,   required=False, help="Mean")
        parser.add_argument("-sig",  "--sigma",          type=float,   required=False, help="Standard deviation")
