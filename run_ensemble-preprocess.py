...
def main(path_start, initialisation, num_nodes, r_max):
    """
    """
    reps = range(r_max+1)
    for r in reps:
    ...
    subprocess.run(["python3", "run_ensemble-preprocess-stats.py", "--path_results", path_sim, "--num_nodes", str(num_nodes), "--initialisation", initialisation, "--r_max", str(r_max)])
