...
num_bins_in_range = 50
num_pts_to_interp = 50
...
ax.plot(N_smooth, (mean_1[-1])*numpy.ones_like(N_smooth), color="tab:blue", ls="--", label=r"$\mathbb{E}[k^{11}_{N \rightarrow \infty}]$")
