...
ax.plot(sigma_smooth, numpy.exp(conf.mu+0.5*sigma_smooth**2), color="tab:orange", ls="-")
ax.plot(sigma_smooth, numpy.exp(conf.mu)*numpy.ones(shape=sigma_smooth.shape), color="tab:blue", ls="--", label=r"$\bar{G}_{0}$")
...
ax.plot(sigma_smooth, 0.29*sigma_smooth+0.82, color="tab:blue", ls="--")
ax.plot(sigma_smooth, 0.55*sigma_smooth+0.80, color="tab:orange", ls="--")
...
# Plot scatter for distribution means
ax.scatter(sigma_list, g_bar_at_each_sigma_1-mean_at_each_sigma_1, label=r"$\bar{G}-\bar{k}^{11}_{N \rightarrow \infty}$")
...
# Plot scatter for distribution means
ax.scatter(sigma_list, g_bar_at_each_sigma_1-mean_at_each_sigma_1, label=r"$\bar{G}\mathrm{cdf}(\bar{G})-\bar{j}^{1}_{N \rightarrow \infty}$")
...
# Plot guide lines
sigma_smooth = numpy.linspace(min(sigma_list),max(sigma_list),500)
ax.plot(sigma_smooth, numpy.exp(-0.13)*sigma_smooth**2.05, color="tab:orange", ls="-")
...
sigma_smooth = numpy.linspace(min(sigma_list),max(sigma_list),500)
#ax.plot(sigma_smooth, numpy.exp(conf.mu+0.5*sigma_smooth**2)*conf.get_cdf(numpy.exp(conf.mu+0.5*sigma_smooth**2)), color="tab:orange", ls="-")
ax.plot(sigma_smooth, numpy.exp(-0.8)*sigma_smooth**1.6, color="tab:orange", ls="-")
...
# Plot scatter for distribution means
ax.scatter(numpy.log(sigma_list), numpy.log(g_bar_at_each_sigma_1-mean_at_each_sigma_1), label=r"$\mathrm{log}(\bar{G}-\bar{k}^{11}_{N \rightarrow \infty})$")

# Plot guide lines
sigma_smooth = numpy.linspace(min(sigma_list),max(sigma_list),500)
ax.plot(numpy.log(sigma_smooth), 2.05*numpy.log(sigma_smooth)-0.13, color="tab:blue", ls="--")
...
# Plot scatter for distribution means
ax.scatter(numpy.log(sigma_list), numpy.log(g_bar_at_each_sigma_1-mean_at_each_sigma_1), label=r"$\bar{G}\mathrm{cdf}(\bar{G})-\bar{j}^{1}_{N \rightarrow \infty}$")

# Plot guide lines
sigma_smooth = numpy.linspace(min(sigma_list),max(sigma_list),500)
ax.plot(numpy.log(sigma_smooth), 1.6*numpy.log(sigma_smooth)-0.8, color="tab:blue", ls="--")
