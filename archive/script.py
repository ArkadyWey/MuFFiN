...
#plt.plot(conc_max_disc_1, cond_tabl_4[:,0,1,0],label=r"$G_{01}^{1}$")
##plt.plot(conc_max_disc_1, cond_tabl_4[:,1,0,0])
#plt.plot(conc_max_disc_1, cond_tabl_4[:,1,3,0],label=r"$G_{13}^{1}$")
##plt.plot(conc_max_disc_1, cond_tabl_4[:,3,1,0])
#plt.plot(conc_max_disc_1, cond_tabl_4[:,2,3,0],label=r"$G_{23}^{1}$")
##plt.plot(conc_max_disc_1, cond_tabl_4[:,3,2,0])
#plt.plot(conc_max_disc_1, cond_tabl_4[:,0,2,0],label=r"$G_{02}^{1}$")
##plt.plot(conc_max_disc_1, cond_tabl_4[:,2,0,0],label=r"$G_{20}^{1}$")
...
#plt.show()
#
#plt.plot(conc_max_disc_1, adhe_tabl_4[:,0,1,0],label=r"$G_{01}^{1}$")
##plt.plot(conc_max_disc_1, adhe_tabl_4[:,1,0,0])
#plt.plot(conc_max_disc_1, adhe_tabl_4[:,1,3,0],label=r"$G_{13}^{1}$")
##plt.plot(conc_max_disc_1, adhe_tabl_4[:,3,1,0])
#plt.plot(conc_max_disc_1, adhe_tabl_4[:,2,3,0],label=r"$G_{23}^{1}$")
##plt.plot(conc_max_disc_1, adhe_tabl_4[:,3,2,0])
#plt.plot(conc_max_disc_1, adhe_tabl_4[:,0,2,0],label=r"$G_{02}^{1}$")
##plt.plot(conc_max_disc_1, adhe_tabl_4[:,2,0,0],label=r"$G_{20}^{1}$")
