...
def four_reg_prescribed(num_nodes: int, num_refs: int):
    ...
    if num_nodes == 1:
        ...
        # Internal edges
        cond_init_4[0,1,0,0] = 0.1#1.2#1.72461##0.8 #1.0
        cond_init_4[1,0,0,0] = 0.1#1.2#1.72461##0.8 #1.0

        cond_init_4[1,3,0,0] = 0.2#1.2#1.72461#1.0#0.2 #1.0
        cond_init_4[3,1,0,0] = 0.2#1.2#1.72461#1.0#0.2 #1.0

        cond_init_4[2,3,0,0] = 0.3#1.2#1.72461#1.0#0.4 #1.0
        cond_init_4[3,2,0,0] = 0.3#1.2#1.72461#1.0#0.4 #1.0

        cond_init_4[0,2,0,0] = 0.4#1.2#1.72461#1.0#0.6 #1.0
        cond_init_4[2,0,0,0] = 0.4#1.2#1.72461#1.0#0.6 #1.0

        ## External edges
        cond_init_4[1,0,1,0]  = 0.5#1.2#1.72461#1.0#1.0 #1.0
        cond_init_4[0,1,-1,0] = 0.5#1.2#1.72461#1.0#1.0 #1.0

        cond_init_4[3,2,1,0]  = 0.6#1.2#1.72461#1.0#1.0 #1.0
        cond_init_4[2,3,-1,0] = 0.6#1.2#1.72461#1.0#1.0 #1.0
        
        cond_init_4[0,2,0,1]  = 0.7#1.2#1.72461#1.0
        cond_init_4[2,0,0,-1] = 0.7#1.2#1.72461#1.0
        
        cond_init_4[1,3,0,1]  = 0.8#1.2#1.72461#1.0
        cond_init_4[3,1,0,-1] = 0.8#1.2#1.72461#1.0
