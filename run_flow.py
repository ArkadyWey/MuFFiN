...
def main(conc_max_disc_1,perm_prep_1,depo_prep_1,
         posi_1,time_1,
         phi,conc_in,
         dt,dx):
    """
    ...
    conc_max_2 = numpy.zeros(shape=(num_positions,num_times))
    ...
    for i_t in range(num_times):
        ...
        for i_x in range(num_positions): 
            #conc_2,conc_max_2,perm_2,depo_2,velo_1,dpdx_2,psi_2 = flow.step(conc_2=conc_2,conc_max_2=conc_max_2,perm_2=perm_2,depo_2=depo_2,velo_1=velo_1,dpdx_2=dpdx_2,psi_2=psi_2,
            #                                                                conc_max_disc_1=conc_max_disc_1,perm_prep_1=perm_prep_1,depo_prep_1=depo_prep_1,
            #                                                                posi_1=posi_1,
            ...
            conc_max_2[i_x,i_t] = flow.get_maximum_concentration_at_time_and_position(conc_2=conc_2,i_t=i_t,i_x=i_x)

            perm_2[i_x,i_t], depo_2[i_x,i_t] = flow.get_permeability_and_deposition_at_time_and_position(conc_max_disc_1=conc_max_disc_1,
...
if __name__ == "__main__":
    ...
    (conc_2,conc_max_2,perm_2,depo_2,velo_1,dpdx_2,psi_2) = main(conc_max_disc_1=conc_max_disc_1,perm_prep_1=perm_prep_1,depo_prep_1=depo_prep_1,
    ...
    numpy.save(file=os.path.join(path_results,"conc_max_2.npy"), arr=conc_max_2, allow_pickle=True, fix_imports=True)
